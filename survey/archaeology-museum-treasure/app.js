/**
 * MuseumCheck Application - Archaeology Museum Treasure Survey functionality
 * Handles user interaction for Chinese Archaeology Museum treasure identification quiz
 */
...
function getDefaultMuseumData() {
    return {
        ...
        collections: [
            {
                name: "绿松石龙形器",
                imageUrl: "https://upload.wikimedia.org/wikipedia/commons/a/a2/20240815_Erlitou_Site_05.jpg",
                description: "二里头遗址出土，距今约3700年，由2000多片绿松石组成"
            },
            {
                name: "嵌绿松石象牙杯",
                imageUrl: "https://upload.wikimedia.org/wikipedia/commons/a/a2/20240815_Erlitou_Site_05.jpg",
                description: "商代早期王室饮器，工艺精湛"
            },
            {
                name: "甲骨文",
                imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/Beijing_Forbidden_City_water_vessel-20071018-RM-150052.jpg/600px-Beijing_Forbidden_City_water_vessel-20071018-RM-150052.jpg",
                description: "中国现存最早的成熟文字系统"
            }
        ]
    };
}
...
async function setupPageContent() {
    ...
    if (museumImage && museumData && museumData.image) {
        ...
        museumImage.alt = museumData.name || '中国考古博物馆';
    }
    ...
    // Add the correct answer (first treasure from Archaeology Museum)
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: "/pages/rewardedWebview/rewardedWebview?target=survey/archaeology-museum-treasure&flow=rewarded",
        });
    } else {
            ...
            <div class="answer-card">
                ...
                <div class="answer-content">
                    ...
                    <div class="answer-info">
                        ...
                        <p class="answer-museum">来自：${correctTreasure.museumName || '中国考古博物馆'}</p>
