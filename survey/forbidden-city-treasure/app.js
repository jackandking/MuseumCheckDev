/**
 * MuseumCheck Application - Forbidden City Treasure Survey functionality
 * Handles user interaction for Forbidden City treasure identification quiz
 */
...
function getDefaultMuseumData() {
    return {
        id: "forbidden-city",
        name: "故宫博物院",
        image: "https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fci.xiaohongshu.com%2F9b96b78f-16e1-7d8b-6ac6-988cc81bf33c%3FimageView2%2F2%2Fw%2F1080%2Fformat%2Fjpg&refer=http%3A%2F%2Fci.xiaohongshu.com&app=2002&size=f9999,10000&q=a80&n=0&g=0n&fmt=auto?sec=1766091319&t=82d060c26a22f76e36914d8adf9d33c3",
        collections: [
            {
                name: "《清明上河图》",
            ...
            {
                name: "太和殿金漆雕龙宝座",
                imageUrl: "https://miaobi-lite.bj.bcebos.com/miaobi/5mao/b%276b6Z5qSF5Zu%2B54mHXzE3MzQ3MTUwNzYuNDk3MDIyMl8xNzM0NzE1MDc2LjgxODE2NDY%3D%27/1.png",
                description: "九龙环绕象征九五之尊"
            },
            {
                name: "金瓯永固杯",
                imageUrl: "https://upload.wikimedia.org/wikipedia/commons/9/98/%E9%87%91%E7%94%8C%E6%B0%B8%E5%9B%BA%E6%9D%AF.png",
                description: "清代皇帝元旦开笔仪式专用礼器"
            }
        ]
    };
}
...
async function setupPageContent() {
    ...
    if (museumImage && museumData && museumData.image) {
        ...
        museumImage.alt = museumData.name || '故宫博物院';
    }
    ...
    // Add the correct answer (first treasure from Forbidden City)
...
function showAd() {
    if (typeof ks !== 'undefined' && ks.navigateTo) {
        ks.navigateTo({
            url: "/pages/rewardedWebview/rewardedWebview?target=survey/forbidden-city-treasure&flow=rewarded",
        });
    } else {
            ...
            <div class="answer-card">
                ...
                <div class="answer-content">
                    ...
                    <div class="answer-info">
                        ...
                        <p class="answer-museum">来自：${correctTreasure.museumName || '故宫博物院'}</p>
