...
YEAR = 2026
MID = "henan-museum"            # museums-meta.json 里的 id
NAME = "河南博物院"              # 馆名（与 MySQL/meta 一致）
PROV = "河南省"                 # 省份（DEDUP_KEY 已设，此字段仅作回退）
...
MUSEUM_PHOTO_COMMONS = "File:20210220 Henan Museum - main hall 01.jpg"
# 上传到服务器后的文件名（务必唯一 slug，避免后端按原名去重冲突）
MUSEUM_PHOTO_FILENAME = "henan-museum-photo-v1.jpg"

# 3 件镇馆之宝（均确藏河南博物院、Commons 有 CC 图；河南博物院"九大镇院之宝"选 3）
TREASURES = [
    {
        "name": "妇好鸮尊", "dynasty": "商代晚期", "category": "青铜器",
        "commons": "File:Fuhao Owl Zun front.jpg",
        "filename": "henan-museum-t1-v1.jpg",
        ...
        "rightsType": "CC", "license": "CC BY-SA 4.0", "copyrightHolder": "Cangmin (Wikimedia Commons)",
        "attribution": "Cangmin / CC BY-SA 4.0, via Wikimedia Commons",
    },
    {
        "name": "莲鹤方壶", "dynasty": "春秋中期", "category": "青铜器",
        "commons": "File:河南博物院藏莲鹤方壶.jpg",
        "filename": "henan-museum-t2-v1.jpg",
        ...
        "rightsType": "CC", "license": "CC BY 3.0", "copyrightHolder": "Greg_kf (Wikimedia Commons)",
        "attribution": "Greg_kf / CC BY 3.0, via Wikimedia Commons",
    },
    {
        "name": "云纹铜禁", "dynasty": "春秋中期", "category": "青铜器",
        "commons": "File:Bronze jin from Henan.jpg",
        "filename": "henan-museum-t3-v1.jpg",
        ...
        "rightsType": "CC", "license": "CC BY-SA 3.0", "copyrightHolder": "Greg_kf (Wikimedia Commons)",
