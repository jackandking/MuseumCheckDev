...
# -*- coding: utf-8 -*-
"""
中国国家博物馆 馆藏图「自托管」补充脚本（museumcheck.cn）

背景：KV `museum-data-national-museum` 早有 6 件镇馆之宝（名称/简述齐全），但所有图均为
...
- 馆照  File:中国国家博物馆.JPG
- 后母戊鼎 / 四羊方尊 / 击鼓说唱俑 / 人面鱼纹彩陶盆 / 大盂鼎 / 金缕玉衣
"""
...
YEAR = 2026
MID = "national-museum"          # museums-meta.json 里的 id
NAME = "中国国家博物馆"           # 馆名（与 MySQL/meta 一致）
PROV = "北京市"                   # 省份（DEDUP_KEY 已设，此字段仅作回退）
# ★ 显式 dedupe key，与 MySQL 现有 7 行一致 → upsert 原地更新，不造重复行
DEDUP_KEY = "北京市_中国国家博物馆"
UA = {"User-Agent": "MuseumCheckBot/1.0 (contact: admin@museumcheck.cn)"}

# 馆照：Commons 文件页标题；经 Special:FilePath?width=1280 下载
MUSEUM_PHOTO_COMMONS = "File:中国国家博物馆.JPG"
MUSEUM_PHOTO_FILENAME = "national-museum-photo-v1.jpg"
# 直连全图路径（稳定；Special:FilePath 重定向到的 /thumb/ 路径本沙箱间歇失败）
MUSEUM_PHOTO_DIRECT = "https://upload.wikimedia.org/wikipedia/commons/8/8b/%E4%B8%AD%E5%9B%BD%E5%9B%BD%E5%AE%B6%E5%8D%9A%E7%89%A9%E9%A6%86.JPG"

# 6 件镇馆之宝（名称/描述复用 KV 现有；补朝代/类别/来源；图全部自托管）
TREASURES = [
    {
        "name": "后母戊鼎", "dynasty": "商", "category": "青铜礼器",
        "commons": "File:后母戊鼎.png",
        "filename": "national-museum-t1-v1.jpg",
        "direct": "https://upload.wikimedia.org/wikipedia/commons/9/9d/%E5%90%8E%E6%AF%8D%E6%88%8A%E9%BC%8E.png",
    ...
    {
        "name": "四羊方尊", "dynasty": "商", "category": "青铜礼器",
        "commons": "File:Square_zun_with_four_sheep_01.jpg",
        "filename": "national-museum-t2-v1.jpg",
        "direct": "https://upload.wikimedia.org/wikipedia/commons/a/ae/Square_zun_with_four_sheep_01.jpg",
    ...
    {
        "name": "击鼓说唱俑", "dynasty": "东汉", "category": "陶俑",
        "commons": "File:Eastern_Han_Pottery_Storyteller_Figure.jpg",
        "filename": "national-museum-t3-v1.jpg",
        "direct": "https://upload.wikimedia.org/wikipedia/commons/9/95/Eastern_Han_Pottery_Storyteller_Figure.jpg",
    ...
    {
        "name": "人面鱼纹彩陶盆", "dynasty": "新石器（仰韶文化）", "category": "彩陶",
        "commons": "File:人面鱼纹彩陶盆08737.jpg",
        "filename": "national-museum-t4-v1.jpg",
        "direct": "https://upload.wikimedia.org/wikipedia/commons/2/26/%E4%BA%BA%E9%9D%A2%E9%B1%BC%E7%BA%B9%E5%BD%A2%E5%BD%A9%E9%99%B6%E7%9B%8608737.jpg",
    ...
    {
        "name": "大盂鼎", "dynasty": "西周", "category": "青铜礼器",
        "commons": "File:Da_Yu_ding.jpg",
        "filename": "national-museum-t5-v1.jpg",
        "direct": "https://upload.wikimedia.org/wikipedia/commons/8/84/Da_Yu_ding.jpg",
    ...
    {
        "name": "金缕玉衣", "dynasty": "西汉", "category": "葬玉",
        "commons": "File:金缕玉衣_狮子山汉墓.jpg",
        "filename": "national-museum-t6-v1.jpg",
        "direct": "https://upload.wikimedia.org/wikipedia/commons/2/2d/%E9%87%91%E7%BC%95%E7%8E%89%E8%A1%A3_%E7%8B%AE%E5%AD%90%E5%B1%B1%E6%B1%89%E5%A2%93.jpg",
