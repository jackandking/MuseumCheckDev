        ...
        test('should have treasure contributor configuration in APP_CONFIG', () => {
            ...
            if (typeof APP_CONFIG !== 'undefined') {
                ...
                if (APP_CONFIG.TREASURE_CONTRIBUTOR) {
                    ...
                    expect(APP_CONFIG.TREASURE_CONTRIBUTOR.FILE_UPLOAD_ENDPOINT).toBe('https://letmetry.cloud/file/upload');
    ...
    describe('File Upload Configuration', () => {
        test('should have letmetry.cloud file upload endpoint in config', () => {
            ...
            if (APP_CONFIG && APP_CONFIG.TREASURE_CONTRIBUTOR) {
                ...
                const expectedEndpoint = 'https://letmetry.cloud/file/upload';
